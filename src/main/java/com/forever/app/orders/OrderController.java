...
public class OrderController {
	...
	public ResponseEntity<?> manageAllOrders(@RequestAttribute("X-User-Details") String userDetails) throws JsonMappingException, JsonProcessingException{
	...
	public ResponseEntity<?> updateOrderStatus(@RequestAttribute("X-User-Details") String userDetails, @RequestBody Map<String, Object> request) throws JsonMappingException, JsonProcessingException{
